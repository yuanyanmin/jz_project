    ...
    data() {
        return {
            ...
            tableLabel4G: [
                ...
                { key: '优良样本总量', label: '4G优良样本总量', width:'180'},
                { key: '用户数', label: '4G用户数', width:'120'}
            ],
            tableLabel5G: [
                { key: '省份', label: '省份', width:'80'},
                { key: '覆盖率', label: '4G覆盖率', width:'80'},
                { key: '样本总量', label: '4G样本总量', width:'100'},
                { key: '优良样本总量', label: '4G优良样本总量', width:'100'},
...
<style lang="scss" scoped>
    .warning{
        ...
        ::v-deep .el-table__body tr.current-row > td {
          background-color: #5d6572 !important;
        }
